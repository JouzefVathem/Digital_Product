...
class PaymentView(APIView):
    ...
    def get(self, request):
        ...
        return Response({'token': payment.token, 'callback_url': 'https://somting.com/payments/pay/'})
    ...
    def post(self, request):
        ...
        r = requests.post('bank_verify_urls', data={})
        ...
        Subscription.objects.create(
            ...
            expires_time=timezone.now() + timezone.timedelta(days=payment.package.duration.days)
        )
